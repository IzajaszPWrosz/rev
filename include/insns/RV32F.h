...
class RV32F : public RevExt{
  ...
  static bool fmadds(RevFeature *F, RevRegFile *R, RevMem *M, RevInst Inst) {
    R->SetFP(Inst.rd, rev_fma(R->GetFP<float>(Inst.rs1), R->GetFP<float>(Inst.rs2), R->GetFP<float>(Inst.rs3)));
    R->AdvancePC(Inst);
    return true;
  }
  ...
  std::vector<RevInstEntry>RV32FTable = {
    ...
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fmadd.s %rd, %rs1, %rs2, %rs3"      ).SetOpcode( 0b1000011).SetFunct3( 0b0    ).SetFunct7(0b0     ).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegFLOAT).SetFormat(RVTypeR4).SetRaiseFPE(true).SetImplFunc(&fmadds ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fmsub.s %rd, %rs1, %rs2, %rs3"      ).SetOpcode( 0b1000111).SetFunct3( 0b0    ).SetFunct7(0b0     ).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegFLOAT).SetFormat(RVTypeR4).SetRaiseFPE(true).SetImplFunc(&fmsubs ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fnmsub.s %rd, %rs1, %rs2, %rs3").SetOpcode( 0b1001011).SetFunct3( 0b0         ).SetFunct7(0b0     ).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegFLOAT).SetFormat(RVTypeR4).SetRaiseFPE(true).SetImplFunc(&fnmsubs ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fnmadd.s %rd, %rs1, %rs2, %rs3").SetOpcode( 0b1001111).SetFunct3( 0b0         ).SetFunct7(0b0     ).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegFLOAT).SetFormat(RVTypeR4).SetRaiseFPE(true).SetImplFunc(&fnmadds ).InstEntry},

    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fadd.s %rd, %rs1, %rs2"           ).SetOpcode( 0b1010011).SetFunct3( 0b0    ).SetFunct7(0b000000).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fadds ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fsub.s %rd, %rs1, %rs2"           ).SetOpcode( 0b1010011).SetFunct3( 0b0    ).SetFunct7(0b0000100).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fsubs ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fmul.s %rd, %rs1, %rs2"           ).SetOpcode( 0b1010011).SetFunct3( 0b0    ).SetFunct7(0b0001000).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fmuls ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fdiv.s %rd, %rs1, %rs2"           ).SetOpcode( 0b1010011).SetFunct3( 0b0      ).SetFunct7(0b0001100).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fdivs ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fsqrt.s %rd, %rs1"              ).SetOpcode( 0b1010011).SetFunct3( 0b0        ).SetFunct7(0b0101100).Setrs2Class(RevRegClass::RegUNKNOWN).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fsqrts ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fmin.s %rd, %rs1, %rs2"           ).SetOpcode( 0b1010011).SetFunct3( 0b000  ).SetFunct7(0b0010100).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fmins ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fmax.s %rd, %rs1, %rs2"           ).SetOpcode( 0b1010011).SetFunct3( 0b001  ).SetFunct7(0b0010100).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fmaxs ).InstEntry},
    ...
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fcvt.w.s %rd, %rs1"           ).SetOpcode( 0b1010011).SetFunct3( 0b0          ).SetFunct7(0b1100000).SetfpcvtOp(0b00000).Setrs2Class(RevRegClass::RegUNKNOWN).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetfpcvtOp(0b00).SetRaiseFPE(true).SetImplFunc(&fcvtws ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fcvt.wu.s %rd, %rs1"                ).SetOpcode( 0b1010011).SetFunct3( 0b0    ).SetFunct7(0b1100000).SetfpcvtOp(0b00001).Setrs2Class(RevRegClass::RegUNKNOWN).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetfpcvtOp(0b01).SetRaiseFPE(true).SetImplFunc(&fcvtwus ).InstEntry},
    ...
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("feq.s %rd, %rs1, %rs2"              ).SetOpcode( 0b1010011).SetFunct3( 0b010        ).SetFunct7(0b1010000).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&feqs ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("flt.s %rd, %rs1, %rs2"              ).SetOpcode( 0b1010011).SetFunct3( 0b001        ).SetFunct7(0b1010000).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&flts ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fle.s %rd, %rs1, %rs2"              ).SetOpcode( 0b1010011).SetFunct3( 0b000        ).SetFunct7(0b1010000).Setrs2Class(RevRegClass::RegFLOAT  ).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetImplFunc(&fles ).InstEntry},
    ...
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fcvt.s.w %rd, %rs1"           ).SetOpcode( 0b1010011).SetFunct3( 0b0          ).SetFunct7(0b1101000).SetfpcvtOp(0b00000).Setrs2Class(RevRegClass::RegUNKNOWN).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetfpcvtOp(0b00).SetImplFunc(&fcvtsw ).InstEntry},
    {RevInstEntryBuilder<Rev32FInstDefaults>().SetMnemonic("fcvt.s.wu %rd, %rs1"                  ).SetOpcode( 0b1010011).SetFunct3( 0b0          ).SetFunct7(0b1101000).SetfpcvtOp(0b00001).Setrs2Class(RevRegClass::RegUNKNOWN).Setrs3Class(RevRegClass::RegUNKNOWN).SetFormat(RVTypeR).SetRaiseFPE(true).SetfpcvtOp(0b01).SetImplFunc(&fcvtswu ).InstEntry},
