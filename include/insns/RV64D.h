...
class RV64D : public RevExt {
  ...
  std::vector<RevInstEntry> RV64DTable = {
    {RevInstEntryBuilder<Rev64DInstDefaults>().SetMnemonic("fcvt.l.d %rd, %rs1"  ).SetFunct7(0b1100001).SetfpcvtOp(0b10).SetRaiseFPE(true).SetImplFunc( &fcvtld ).InstEntry},
    {RevInstEntryBuilder<Rev64DInstDefaults>().SetMnemonic("fcvt.lu.d %rd, %rs1" ).SetFunct7(0b1100001).SetfpcvtOp(0b11).SetRaiseFPE(true).SetImplFunc( &fcvtlud ).InstEntry},
    {RevInstEntryBuilder<Rev64DInstDefaults>().SetMnemonic("fcvt.d.l %rd, %rs1"  ).SetFunct7(0b1101001).SetfpcvtOp(0b10).SetRaiseFPE(true).SetImplFunc( &fcvtdl ).InstEntry},
    {RevInstEntryBuilder<Rev64DInstDefaults>().SetMnemonic("fcvt.d.lu %rd, %rs1" ).SetFunct7(0b1101001).SetfpcvtOp(0b11).SetRaiseFPE(true).SetImplFunc( &fcvtdlu ).InstEntry},
