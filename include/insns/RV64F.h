...
class RV64F : public RevExt {
  ...
  std::vector<RevInstEntry> RV64FTable = {
    {RevInstEntryBuilder<Rev64FInstDefaults>().SetMnemonic("fcvt.l.s  %rd, %rs1").SetFunct7( 0b1100000).SetfpcvtOp(0b10).Setrs2Class(RevRegClass::RegUNKNOWN).SetRaiseFPE(true).SetImplFunc(&fcvtls ).InstEntry},
    {RevInstEntryBuilder<Rev64FInstDefaults>().SetMnemonic("fcvt.lu.s %rd, %rs1").SetFunct7( 0b1100000).SetfpcvtOp(0b11).Setrs2Class(RevRegClass::RegUNKNOWN).SetRaiseFPE(true).SetImplFunc(&fcvtlus ).InstEntry},
    {RevInstEntryBuilder<Rev64FInstDefaults>().SetMnemonic("fcvt.s.l %rd, %rs1" ).SetFunct7( 0b1101000).SetfpcvtOp(0b10).Setrs2Class(RevRegClass::RegUNKNOWN).SetRaiseFPE(true).SetImplFunc(&fcvtsl ).InstEntry},
    {RevInstEntryBuilder<Rev64FInstDefaults>().SetMnemonic("fcvt.s.lu %rd, %rs1").SetFunct7( 0b1101000).SetfpcvtOp(0b11).Setrs2Class(RevRegClass::RegUNKNOWN).SetRaiseFPE(true).SetImplFunc(&fcvtslu ) .InstEntry},
  };
